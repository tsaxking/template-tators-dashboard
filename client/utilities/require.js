/**
 * @fileoveview This is used to wrap typescript imports and turn them into a node.js type environment
...
!function (global, setTimeout) {
    ...
    function mixin(i, e, r, n) {
        return e && eachProp(e, function (e, t) {
            !r && hasProp(i, t) ||
                (!n || 'object' != typeof e || !e || isArray(e) ||
                        isFunction(e) || e instanceof RegExp
                    ? i[t] = e
    ...
    if (void 0 === define) {
        ...
        (cfg = require, require = void 0),
            ...
            req.load = function (t, i, r) {
                var e, n = t && t.config || {};
                if (isBrowser) {
                    return (e = req.createNode(n, i, r)).setAttribute(
                        'data-requirecontext',
                        t.contextName,
                    ),
                        ...
                        !e.attachEvent ||
                            e.attachEvent.toString &&
                                e.attachEvent.toString().indexOf(
                                        '[native code',
                                    ) < 0 ||
                            isOpera
            ...
            define = function (e, i, t) {
                ...
                'string' != typeof e && (t = i, i = e, e = null),
                    ...
                    !i && isFunction(t) && (i = [],
                        t.length &&
                        (t.toString().replace(commentRegExp, commentReplace)
                            .replace(cjsRequireRegExp, function (e, t) {
                                i.push(t);
                            }),
                            i = (1 === t.length
                                ? ['require']
                                : ['require', 'exports', 'module']).concat(i))),
                    useInteractive &&
    ...
    function newContext(u) {
        ...
        function q(e, t, i) {
            ...
            if (
                ...
                (u = (e = e.split('/')).length - 1,
                    g.nodeIdCompat && jsSuffixRegExp.test(e[u]) &&
        ...
        function M(e, t, i) {
            ...
            !hasProp(m, r) || n && !n.defineEmitComplete
                ? (n = k(e)).error && 'error' === t ? i(n.error) : n.on(t, i)
                : 'defined' === t && i(m[r]);
        }
        function O(i, e) {
                ...
                if (
                    i = !0,
                        eachProp(f, function (e) {
                            var t = e.map, i = t.id;
                            if (
                                e.enabled && (t.isDefine || a.push(e), !e.error)
                            ) {
                                if (!e.inited && n) {
                                    w(i) ? s = r = !0 : (o.push(i), E(i));
                                } else if (
                                    !e.inited && e.fetched && t.isDefine &&
                                    (s = !0, !t.prefix)
                                ) return u = !1;
                            }
                        }),
        ...
        return c = {
            ...
            (e = function (e) {
                ...
                init: function (e, t, i, r) {
                    r = r || {},
                        this.inited ||
                        (this.factory = t,
                            i ? this.on('error', i) : this.events.error &&
            ...
            (l = {
                ...
                makeRequire: function (o, a) {
                    function s(e, t, i) {
                        var r, n;
                        return a.enableBuildCallback && t && isFunction(t) &&
                    ...
                    return a = a || {},
                        ...
                        o || (s.undef = function (i) {
                            ...
                            t.undefed = !0,
                                ...
                                t &&
                                (t.events.defined && (r[i] = t.events), P(i));
                        }),
                        s;
                },
                enable: function (e) {
                ...
                onScriptError: function (e) {
                    ...
                    if (!w(i.id)) {
                        ...
                        return eachProp(p, function (e, t) {
                            ...
                            O(makeError(
                                'scripterror',
                                'Script error for "' + i.id + (r.length
                                    ? '", needed by: ' + r.join(', ')
                                    : '"'),
                                e,
                                [i.id],
