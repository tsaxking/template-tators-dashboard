<script lang="ts">
    ...
    const moveCardUp = (questionId: string, assign: boolean = false) => () => {
                                ...
                                <div class="row mb-1">
                                    <div class="col-12">
                                        <QuestionCard
                                                ...
                                                on:delete={() => removeCard(question.id)}
                                                on:moveCardUp={moveCardUp(question.id, true)}
                                                on:moveCardDown={moveCardDown(question.id)}
                                            >
                                        </QuestionCard>
                                    </div>
                                </div>
