...
const quotes = [
    'Blankets are like hugs you can wear.',
    'No ship has sailed too far if you\'e a really fast swimmer.',
...
<footer>
    <p class="text-muted text-center">
        ...
        <br>
        If you see an issue, please report it <a href="https://github.com/tsaxking/template-tators-dashboard/issues" target="_blank">here</a>.
        <br>

        <a href="https://github.com/tsaxking/template-tators-dashboard" target="_blank">
        
    <i class="fa-solid fa-cat-space">
