...
import { Accounts, Select_whiteboards_from_strategy } from './tables';
...
import { Update_whiteboards_update } from './tables';
...
export type Queries = {
    ...
    'match-scouting/from-id': [[{ id: string }], MatchScouting];
    ...
    'whiteboards/update': [[Update_whiteboards_update], unknown];
