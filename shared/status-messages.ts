...
export const messages: {
    ...
    'tba:not-updated': {
    message: 'the blue alliance has not updated yet, please try again later',
    color: 'warning',
    code: 404,
    instructions: '',
},
...
export type StatusId = 'strategy:invalid'
...
export type AccountNotificationStatusId = 'deleted'
	| 'mark-read'
	| 'mark-unread'
	| 'not-found'
	| 'not-owner';
...
export type ScoutingQuestionStatusId = 'answer-deleted'
	| 'answer-not-found'
	| 'group-deleted'
	| 'group-updated'
	| 'new-answer'
...
export type WebhookStatusId = 'invalid-url'
	| 'not-found'
	| 'rate-limit';


export type WhiteboardStatusId = 'created'
	| 'deleted'
	| 'match-not-found'
	| 'not-found'
	| 'update';
