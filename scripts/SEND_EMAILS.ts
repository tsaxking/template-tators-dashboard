...
//         async () => {
//             const matches = (
//                 await TBA.get<unknown[]>('/event/2024cabl/matches/simple')
//             ).unwrap();
...
//                     'stuart.king@boiseschools.org',
//                     'stuking65@gmail.com',
//                     'raygenrrupe@gmail.com'
//                 ],
...
//                     constructor: {
//                         message:
//                             'The match schedule for the upcoming competition has been released. Please check the schedule to see when your team is competing.',
